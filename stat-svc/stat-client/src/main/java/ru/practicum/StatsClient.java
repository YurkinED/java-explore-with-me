...
public class StatsClient {
    ...
    public Mono<EventStatDto> post(EventStatDto eventStatDto) {
        return client.post()
                .uri("/hit")
                .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .body(Mono.just(eventStatDto), EventStatDto.class)
                .retrieve()
                .bodyToMono(EventStatDto.class);
    }

    public Flux<ViewStats> getStats(
